...
SELECT students.* , addresses.country, addresses.zipCode, addresses.address, addresses.city
FROM students
...
ALTER TABLE students ADD COLUMN age DATE;


UPDATE students
SET age = CASE 
    WHEN id = 1 THEN "1980-01-24" 
    WHEN id = 2 THEN "1985-09-20"
    WHEN id = 3 THEN "1990-11-02" 
    WHEN id = 4 THEN "1995-03-10" 
    WHEN id = 5 THEN "2000-08-28" 
    ELSE "1900-01-01"
    END
